...
class FaqsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('faqs.index',compact('faqs','categoriesList','category','keyword'));
    }
    ...
    public function confirmEdit(Request $request, $id)
    {
        ...
        $validator = Validator::make(
            ...
            [
                ...
                'change_summary' => ['exclude_unless:faq_history,1', 'required', 'string', 'max:25'],
            ],
            [
    ...
    public function search(Request $request)
    {
        ...
        $faqs = Faqs::search($category, $keyword)->get();
        ...
        return redirect()->route('faqs.search',compact('faqs','categoriesList', 'category', 'keyword'));   
    }
}