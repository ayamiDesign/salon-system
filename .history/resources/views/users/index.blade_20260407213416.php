                            ...
                            <div class="admin-entity-body">
                                <div class="admin-entity-main">
                                    ...
                                    <div class="admin-entity-meta">
                                        <span class="admin-entity-chip admin-entity-chip--role">
                                            {{ $user->role }}
                                        </span>

                                        <span class="admin-entity-chip admin-entity-chip--status {{ $user->is_active ? 'admin-entity-chip--success' : 'admin-entity-chip--danger' }}">
