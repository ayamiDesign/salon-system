    ...
    <main class="category-layout-single">
        <section class="content">
            ...
            <section class="faq-card form-card">
                ...
                <form action="{{ route('accounts.confirm') }}" method="post" class="form-body">
                    @csrf

                    <div class="input-list-card">
                        <div class="input-list-head input-list-head-edit">
                            <div class="input-list-col-no">項目</div>
                            <div class="input-list-col-name">入力内容</div>
                        </div>

                        <div class="input-list-body">
                            <div class="input-row">
                                <div class="input-row-grid-edit">
                                    <div class="input-cell">
                                        <label class="mobile-label">項目</label>
                                        <div class="row-number">名前</div>
                                    </div>
                                    <div class="input-cell">
                            ...
                            <div class="input-row">
                                <div class="input-row-grid-edit">
                                    <div class="input-cell">
                                        <label class="mobile-label">項目</label>
                                        <div class="row-number">権限</div>
                                    </div>
                                    <div class="input-cell">
                                        <label class="mobile-label">
                                            権限 <span class="required-badge">必須</span>
                                        </label>
                                        <select name="role" class="text-select" required>
                                            <option value="">選択してください</option>
                                            <option value="admin" {{ old('role', $sessionInput['role'] ?? '') === 'admin' ? 'selected' : '' }}>管理者</option>
                                            <option value="manager" {{ old('role', $sessionInput['role'] ?? '') === 'manager' ? 'selected' : '' }}>マネージャー</option>
                            ...
                            <div class="input-row">
                                <div class="input-row-grid-edit">
                                    <div class="input-cell">
                                        <label class="mobile-label">項目</label>
                                        <div class="row-number">状態</div>
                                    </div>
                                    <div class="input-cell">
                                        <label class="mobile-label">
                                            利用状態 <span class="required-badge">必須</span>
                                        </label>
                                        <select name="is_active" class="text-select" required>
