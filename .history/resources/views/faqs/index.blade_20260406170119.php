            ...
            <div class="sidebar-card">
                ...
                <div class="category-list">
                    ...
                    @foreach($categoriesList as $categories)
                        <a
                            href="{{ route('faqs.search', ['category' => $categories['id'], 'keyword' => request('keyword', '')]) }}"
                            class="category-button {{ ($category ?? '0') == $categories['id'] ? 'is-active' : '' }}"
                        >
                            <span class="category-name">{{ $categories['name'] }}</span>
                            <span class="category-count">{{ $categories['count'] }}件</span>
                        </a>
                    @endforeach
                </div>
            </div>
