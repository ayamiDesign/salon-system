...
<body class="bg-slate-50 text-slate-800">
    <div class="min-h-screen">
        ...
        <main class="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <section class="mt-6 rounded-2xl border border-slate-200 bg-white shadow-soft">
                ...
                <form action="{{ route('faqs.confirm') }}" method="post" class="p-5" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    class="block w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 file:mr-3 file:rounded-md file:border-0 file:bg-accent-600 file:px-3 file:py-2 file:text-sm file:font-medium file:text-white hover:file:bg-accent-700"
                                                >
    ...
    <script>
        ...
        function addFaqBlock() {
            ...
            const index = document.querySelectorAll('#faq-list .faq-block').length;

            const div = document.createElement('div');
            div.className = 'faq-block rounded-2xl border border-slate-200 bg-slate-50/70 p-4 sm:p-5';
        ...
        function removeFaqBlock(button) {
            const rows = document.querySelectorAll('#faq-list .faq-block');
        ...
        function updateFaqNumbers() {
            document.querySelectorAll('#faq-list .faq-block').forEach((block, index) => {
