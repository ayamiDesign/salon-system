            ...
            <div class="sidebar-card">
                ...
                <div class="category-list">
                    ...
                    >
                        ...
                        <span class="category-count">{{ $faqCount }}件</span>
                    </a>
                    ...
                    <div id="pc-sortable-body">
                        @foreach($faqs as $index => $faq)
                            <article
                                ...
                                data-id="{{ $faq->id }}"
                                data-order="{{ $faqs->firstItem() + $index }}"
                            >
                                <details class="faq-details">
                                    <summary class="faq-head">
                                        <div class="faq-head-main">
                                            <div class="faq-meta">
                                                <span class="sort-order-badge js-sort-order-label">{{ $faqs->firstItem() + $index }}</span>

                                                @if(auth()->user()->role === 'admin')
                                                    <span class="visibility-badge {{ $faq->is_visible ? 'is-visible' : 'is-hidden' }}">
                                        ...
                                        <div class="faq-head-side">
                                            <div class="faq-quick-actions">
                                                ...
                                                {{-- ︙メニュー --}}
                                                <details class="faq-action-menu">
                                                    <summary class="faq-action-menu-button" aria-label="操作メニュー">
                                                        ⋯
                                                    </summary>

                                                    <div class="faq-action-menu-list">

                                                        @if(auth()->user()->role === 'admin')
                                                            <a href="{{ route('faqs.edit', $faq->id) }}" class="faq-action-menu-link">
                                                                編集
                                                            </a>

                                                            <button
                                                                type="button"
                                                                class="faq-action-menu-link faq-action-menu-link-danger js-delete-open"
                                                                data-id="{{ $faq->id }}"
                                                        ...
                                                        <a href="{{ route('faqs.histories.index', $faq->id) }}" class="faq-action-menu-link">
                                                            履歴
                                                        </a>
