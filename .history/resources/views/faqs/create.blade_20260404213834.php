            ...
            <section class="mt-6 rounded-2xl border border-slate-200 bg-white shadow-soft">
                ...
                <form action="{{ route('faqs.store') }}" method="post" class="p-5">
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div>
                                    <label for="category_id" class="mb-2 block text-sm font-medium text-slate-700">
                                        カテゴリ <span class="text-rose-500">必須</span>
                                    </label>
                                    <select
                                        id="category_id"
                                        name="category_id"
                        ...
                        <!-- 履歴メモ -->
                        <div class="rounded-xl border border-slate-200 bg-slate-50/70 p-4 sm:p-5">
                            <h4 class="text-sm font-semibold text-slate-900">変更メモ</h4>
                            <p class="mt-1 text-sm text-slate-500">
                                任意入力です。重要な登録内容を残したい場合に入力してください。
                            </p>

                            <div class="mt-4">
                                <label for="change_summary" class="mb-2 block text-sm font-medium text-slate-700">
                                    変更メモ（任意）
                                </label>
                                <textarea
                                    id="change_summary"
