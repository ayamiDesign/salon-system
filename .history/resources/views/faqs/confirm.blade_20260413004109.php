                ...
                <section class="faq-card form-card">
                    <div class="form-card-header">
                        <div>
                            ...
                            <p class="form-card-sub">登録前に内容を確認し、問題がなければ登録してください。</p>
                        </div>
                                    ...
                                    <div class="faq-form-block-head">
                                        <div class="faq-form-block-title-wrap">
                                            ...
                                            <div>
                                                ...
                                                <p class="faq-form-block-sub">登録前の内容確認</p>
                                            </div>
                                        </div>
                                    </div>
            ...
            @if($mode === 'edit')
                <section class="faq-card form-card">
                    ...
                    <div class="form-body">
                                ...
                                <div class="faq-form-block-head">
                                    <div class="faq-form-block-title-wrap">
                                        ...
                                        <div>
                                            ...
                                            <p class="faq-form-block-sub">更新内容に誤りがないか確認してください。</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-actions">
                            <form action="{{ route('faqs.edit.back', $id) }}" method="post" class="form-action-form">
                                @csrf
                            ...
                            <form action="{{ route('faqs.update', $id) }}" method="post" class="form-action-form">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="category1_id" value="{{ $requestData['category1_id'] }}">
                                <input type="hidden" name="category2_id" value="{{ $requestData['category2_id'] ?? '' }}">
