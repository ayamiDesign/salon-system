    ...
    <main class="layout">
        <aside class="sidebar">
            <div class="sidebar-card">
                ...
                <div class="category-list">
                    <a
                        href="{{ route('faqs.search', ['category' => 0, 'keyword' => request('searchKeyword', '')]) }}"
                    ...
                    @foreach($categoriesList as $category)
                        <a
                            href="{{ route('faqs.search', ['category' => $category['id'], 'keyword' => request('searchKeyword', '')]) }}"
        ...
        <section class="content">
            <div class="search-panel">
                ...
                <div class="chips">
                    <a
                        href="{{ route('faqs.search', ['keyword' => '施術順', 'category' => request('searchCategory', 0)]) }}"
                    ...
                    <a
                        href="{{ route('faqs.search', ['keyword' => '予約', 'category' => request('searchCategory', 0)]) }}"
                    ...
                    <a
                        href="{{ route('faqs.search', ['keyword' => 'ブロック', 'category' => request('searchCategory', 0)]) }}"
                    ...
                    <a
                        href="{{ route('faqs.search', ['keyword' => 'サロンボード', 'category' => request('searchCategory', 0)]) }}"
