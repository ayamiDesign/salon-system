@php
    $faqInput = [
        'category1_id' => old('category1_id', $sessionInput->category1_id ?? ''),
        'category2_id' => old('category2_id', $sessionInput->category2_id ?? ''),
        'question'     => old('question', $sessionInput->question ?? ''),
        'answer'       => old('answer', $sessionInput->answer ?? ''),
        'note'         => old('note', $sessionInput->note ?? ''),
        'url'          => old('url', $sessionInput->url ?? ''),
        'is_visible'   => old('is_visible', isset($faq->is_visible) ? (int)$faq->is_visible : 1),
        'delete_pdf'   => old('delete_pdf', 0),
        'current_pdf_original_name' => old('current_pdf_original_name', $sessionInput->current_pdf_original_name ?? ''),
        'current_pdf_path'          => old('current_pdf_path', $sessionInput->current_pdf_path ?? ''),
        'faq_history'   => old('faq_history', $sessionInput->faq_history ?? 0),
        'change_summary'=> old('change_summary', $sessionInput->change_summary ?? ''),
    ];
@endphp
