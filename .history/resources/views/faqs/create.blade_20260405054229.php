        ...
        <div class="topbar-inner">
            <div class="brand">
                ...
                <div class="brand-text">
                    <p class="brand-title">FAQ新規登録</p>
                    <p class="brand-sub">FAQ一覧と同じデザインルールで統一した登録画面</p>
                </div>
            </div>
        ...
        <section class="content">
            <div class="search-panel">
                <div class="search-copy">
                    ...
                    <p class="search-sub">
                        複数のFAQをまとめて登録できます。スマホでも入力しやすいように1件ずつカードで整理しています。
                    </p>
                </div>
            </div>
            ...
            <section class="faq-card form-card">
                <div class="form-card-header">
                    <div>
                        ...
                        <p class="form-card-sub">必要なFAQをまとめて追加できます。</p>
                    </div>
                ...
                <form action="{{ route('faqs.confirm') }}" method="post" class="form-body" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        <a
                            href="{{ route('faqs.index') }}"
                            class="form-secondary-button form-back-button"
                        >
                            キャンセル
                        </a>
