            ...
            <div class="sidebar-card">
                ...
                <div class="category-list">
                    <a
                        ...
                        class="category-button {{ ($selectedCategory ?? '0') == '0' ? 'is-active' : '' }}"
                    >
                    ...
                    @foreach($categoriesList as $category)
                        <a
                            ...
                            class="category-button {{ ($selectedCategory ?? '') == $category['id'] ? 'is-active' : '' }}"
                        >
        ...
        <section class="content">
            <div class="search-panel">
                ...
                <div class="chips">
                    ...
                    <a href="{{ route('faqs.search',['keyword' => '施術順']) }}" class="chip {{ $keyword === '施術順' ? 'is-active' : '' }}">施術順</a>
                    <a href="{{ route('faqs.search',['keyword' => '予約']) }}" class="chip {{ $keyword === '予約' ? 'is-active' : '' }}">予約</a>
                    <a href="{{ route('faqs.search',['keyword' => 'ブロック']) }}" class="chip {{ $keyword === 'ブロック' ? 'is-active' : '' }}">ブロック</a>
                    <a href="{{ route('faqs.search',['keyword' => 'サロンボード']) }}" class="chip {{ $keyword === 'サロンボード' ? 'is-active' : '' }}">サロンボード</a>
                </div>
