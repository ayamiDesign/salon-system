            ...
            @if(count($filteredFaqs) > 0)
                <div class="faq-list">
                    @foreach($filteredFaqs as $faq)
                        <article class="faq-card {{ (string) $openId === (string) $faq->id ? 'is-open' : '' }}">
                            <div class="faq-head">
                                <div class="faq-head-main">
                                    ...
                                    <h2 class="faq-question">
                                        <a href="{{ build_query(['open' => $faq->id]) }}" class="faq-question-link">
                                ...
                                <div class="faq-head-side">
                                    ...
                                    <a href="{{ build_query(['open' => (string) $openId === (string) $faq->id ? null : $faq->id]) }}" class="faq-toggle">
                                        {{ (string) $openId === (string) $faq->id ? '−' : '+' }}
                                    </a>
                                </div>
                            </div>

                            @if((string) $openId === (string) $faq->id)
                                <div class="faq-body">
