    ...
    <main class="layout">
        ...
        <section class="content">
            <div class="search-panel">
                ...
                <div class="chips">
                    <a
                        href="{{ route('faqs.search', ['searchKeyword' => '施術順', 'searchCategory' => request('searchCategory', 0)]) }}"
                    ...
                    <a
                        href="{{ route('faqs.search', ['searchKeyword' => '予約', 'searchCategory' => request('searchCategory', 0)]) }}"
                    ...
                    <a
                        href="{{ route('faqs.search', ['searchKeyword' => 'ブロック', 'searchCategory' => request('searchCategory', 0)]) }}"
                    ...
                    <a
                        href="{{ route('faqs.search', ['searchKeyword' => 'サロンボード', 'searchCategory' => request('searchCategory', 0)]) }}"
