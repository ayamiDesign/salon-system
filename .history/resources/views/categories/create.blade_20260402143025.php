                                    ...
                                    <div class="grid grid-cols-1 gap-3 md:grid-cols-12 md:items-start">
                                        ...
                                        <div class="md:col-span-3">
                                            ...
                                            <input
                                                ...
                                                value="{{ $displayOrder }}"
                                                disabled
                                                class="sort-display w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm bg-white text-slate-800 disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed"
                                            >
                                            <!-- 送信用 -->
                                            <input type="hidden" name="sort_order[]" value="{{ $displayOrder }}">
                                        </div>
    ...
    <script>
                ...
                <div class="grid grid-cols-1 gap-3 md:grid-cols-12 md:items-start">
                    ...
                    <div class="md:col-span-3">
                        ...
                        <input
                            ...
                            class="sort-display w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm bg-white text-slate-800 disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed"
                        >
                        <input type="hidden" name="sort_order[]" value="${currentOrder}">
                    </div>
        ...
        function reNumbering() {
            ...
            rows.forEach((row, index) => {
                const input = row.querySelector('.sort-display');
                if (input) {
                    input.value = baseOrder + index;
                }
            });

            currentOrder = rows.length;
        }
