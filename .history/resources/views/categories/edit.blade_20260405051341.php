@php
    $session = session('category_input');
@endphp
        ...
        <div class="topbar-inner">
            <div class="brand">
                ...
                <div class="brand-text">
                    <p class="brand-title">カテゴリ編集</p>
                    <p class="brand-sub">一覧ページ・新規登録ページと同じデザインルールで統一した編集画面</p>
                </div>
            </div>
                                ...
                                <div class="input-row-grid input-row-grid-edit">
                                    ...
                                    <div class="input-cell input-cell-name">
                                        ...
                                        <input
                                            type="text"
                                            name="name"
                                            value="{{ old('name', $session['name'] ?? $category->name ?? '') }}"
                                            placeholder="例：予約・受付"
                                            class="text-input"
                                            required
                                        >
