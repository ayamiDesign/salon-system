                ...
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="grid grid-cols-2 gap-3 sm:grid-cols-3">
                        <div class="rounded-xl bg-slate-50 px-4 py-3">
                            ...
                            <p class="mt-1 text-lg font-semibold text-slate-900">{{ count($categories) }}件</p>
                        </div>
                        <div class="rounded-xl bg-slate-50 px-4 py-3">
                            <p class="text-xs text-slate-500">表示中</p>
                            <p class="mt-1 text-lg font-semibold text-slate-900">
                                {{ collect($categories)->where('is_visible', true)->count() }}件
                            </p>
                        </div>
                        <div class="rounded-xl bg-slate-50 px-4 py-3 col-span-2 sm:col-span-1">
                            <p class="text-xs text-slate-500">非表示</p>
                            <p class="mt-1 text-lg font-semibold text-slate-900">
                                {{ collect($categories)->where('is_visible', false)->count() }}件
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="min-w-full text-sm">
                        <thead class="bg-slate-50">
                            <tr class="text-left text-slate-500">
                                ...
                                <th class="px-5 py-3 font-medium">表示状態</th>
